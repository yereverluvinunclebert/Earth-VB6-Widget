...
Begin VB.Form planetPrefs 
   ...
   Begin VB.Frame fraConfig 
      ...
      Begin VB.Frame fraConfigInner 
         ...
         Begin VB.ComboBox cmbScrollWheelDirection 
            Height          =   315
            ItemData        =   "frmPrefs.frx":4337
            Left            =   1995
            List            =   "frmPrefs.frx":4339
            Style           =   2  'Dropdown List
            TabIndex        =   90
   ...
   Begin VB.Frame fraPosition 
      ...
      Begin VB.Frame fraPositionInner 
         ...
         End
         Begin VB.Label lblPosition 
            Caption         =   $"frmPrefs.frx":874A
            Height          =   3045
            Index           =   6
            Left            =   2265
            TabIndex        =   68
            Tag             =   "lblAlarmSoundDesc"
            ToolTipText     =   $"frmPrefs.frx":88E6
            Top             =   450
            Width           =   5175
         End
         Begin VB.Label lblPosition 
...
'    gblPlhLocationPercPrefValue
    ...
    If gblPlStartup = "1" Then
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "EarthMarbleWidget", """" & App.Path & "\" & "earth.exe""")
    Else
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "EarthMarbleWidget", vbNullString)
    End If
...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
       Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/Earth-VB6-Widget", vbNullString, App.Path, 1)
    End If
End Sub
